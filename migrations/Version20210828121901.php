 ...
 */
final class Version20210828121901 extends AbstractMigration
{
    /**
     * @return string
     */
    ...
    {
        return 'Create tables for books and authors';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, year INT NOT NULL, isbn VARCHAR(255) NOT NULL, number_of_pages INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
